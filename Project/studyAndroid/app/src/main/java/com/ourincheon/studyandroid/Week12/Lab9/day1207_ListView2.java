...
public class day1207_ListView2 extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        listView.setAdapter(new FruitAdapter(fruit_list));
    }

    class FruitAdapter extends BaseAdapter {
        ArrayList<day1207_FruitItem> item_list;

        public FruitAdapter(ArrayList<day1207_FruitItem> item_list) {
